...
class SelectedPlaceScreen1 extends StatelessWidget {
  ...
  SelectedPlaceScreen1({Key key, @required this.roomModel1}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          children: <Widget>[
            Hero(
              tag: roomModel1.image,
              child: Container(
                height: MediaQuery.of(context).size.height * 0.5,
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: CachedNetworkImageProvider(roomModel1.image),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Container(
