...
class SelectedPlaceScreen2 extends StatelessWidget {
  ...
  SelectedPlaceScreen2({Key key, @required this.roomModel2}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          children: <Widget>[
            Hero(
              tag: roomModel2.image,
              child: Container(
                height: MediaQuery.of(context).size.height * 0.5,
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: CachedNetworkImageProvider(roomModel2.image),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Container(
