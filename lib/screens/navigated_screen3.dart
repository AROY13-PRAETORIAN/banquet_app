...
class SelectedPlaceScreen3 extends StatelessWidget {
  ...
  SelectedPlaceScreen3({Key key, @required this.roomModel3}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        child: Stack(
          children: <Widget>[
            Hero(
              tag: roomModel3.image,
              child: Container(
                height: MediaQuery.of(context).size.height * 0.5,
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: CachedNetworkImageProvider(roomModel3.image),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Container(
